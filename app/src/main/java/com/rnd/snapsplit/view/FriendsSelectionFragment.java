...
public class FriendsSelectionFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.friend_selection_view, container, false);
        final Activity activity = getActivity();
        final Context context = getContext();

        Bundle bundle = this.getArguments();
        splitTransaction = (Summary) bundle.getSerializable("splitTransaction");
//        splitTransaction = new Summary("test", 123.5f);
        ...
        friendsList.add(new Friend("Raymond", "Sak", "1234 5678", "", R.drawable.damian));
        friendsList.add(new Friend("Megan", "Gibbs", "9422 7284", "", R.drawable.user_blue));
        friendsList.add(new Friend("Bryant", "Ryan", "6990 4671", "", R.drawable.user_blue));
        friendsList.add(new Friend("Drew", "Jennings", "9078 4420", "", R.drawable.user_blue));
        friendsList.add(new Friend("Roman", "Sherman", "7559 0909", "", R.drawable.user_blue));
